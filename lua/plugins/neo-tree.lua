return {
  ...
  -- },
  {
    ...
    config = function()
      ...
      --       [vim.diagnostic.severity.HINT] = 'ÌÆÄÌºµ',
      --     },
      --   }
      -- })
      --
      ...
      -- vim.fn.sign_define("DiagnosticSignHint", { text = "ÌÆÄÌºµ", texthl = "DiagnosticSignHint" })
        ...
        default_component_configs = {
          ...
          git_status = {
            symbols = {
              ...
              renamed = "ÌÆÄÌ±ï", -- this can only be used in the git_status source
              -- Status type
              untracked = "ÔÑ®",
              ignored = "Ôë¥",
              unstaged = "ÌÆÄÌ¥±",
